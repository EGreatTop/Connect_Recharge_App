<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="success.aspx.cs" Inherits="ConnectRechargeWebsite.success" %>
...
<body class="theme-light" data-background="none" data-highlight="red2">
    ...
    <div class="page-content header-clear-medium">
         <div class="content-boxed left-40 right-40 bg-green2-dark">
                <div class="content top-10 bottom-10">
                    <h1 class="center-text top-30"><i class="fa fa-3x fa-check-circle color-white"></i></h1>
        <h1 class="center-text uppercase ultrabold top-30 color-white">Success!</h1>
     ...
     <%--<asp:Button ID="BtnOK" runat="server" CssClass="button button-center-medium button-s button-r bg-white color-black button-3d button-xl" Text="OK" OnClick="BtnOK_Click" />--%>
                    </div>
              </div>
