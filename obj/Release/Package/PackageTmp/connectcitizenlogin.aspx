<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="connectcitizenlogin.aspx.cs" Inherits="ConnectRechargeWebsite.connectcitizenlogin" %>
        ...
        <div class="content-boxed left-40 right-40">
            <div class="content top-10 bottom-20">
                ...
                <%--<div class="input-style has-icon input-style-1 input-required">
                    ...
                    <asp:ListItem>Open Recharge(New Client)</asp:ListItem>
                    <asp:ListItem>Open Recharge(Existing Client)</asp:ListItem>
                    <asp:ListItem>Connect Citizen(New Citizen)</asp:ListItem>
                    <asp:ListItem>Connect Citizen(Existing Citizen)</asp:ListItem>
                ...
                <asp:LinkButton ID="BtnLogin" CssClass="button button-m shadow-large bg-blue2-dark button-center-large button-round-large button-margins" runat="server"  OnClick="BtnLogin_Click">LOGIN</asp:LinkButton>
