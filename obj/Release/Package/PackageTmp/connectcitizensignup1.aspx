<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="connectcitizensignup1.aspx.cs" Inherits="ConnectRechargeWebsite.connectcitizensignup1" %>
...
<title>ConnectRecharge-Citizens1</title>
...
<body class="theme-light" data-background="none" data-highlight="blue2">
	...
	<div class="header header-fixed header-logo-center">
		...
		<a href="openrecharge" class="back-button header-icon header-icon-1"><i class="fas fa-arrow-left"></i></a>
            ...
            <div class="content-boxed left-40 right-40">
                <div class="content top-10 bottom-10">
                    ...
                    <p class="center-text color-highlight font-11 under-heading bottom-30">
                        Want to be a ConectRecharge Citizen? Register here.
                    </p>
                    ...
                    <div class="input-style has-icon input-style-1 input-required">
                        <i class="input-icon fa fa-people-carry font-11"></i>
                        <span>Nickname</span>
                        <em>(required)</em>
                        <asp:TextBox ID="txtNickName" runat="server" placeholder="Enter a nick/friendly name"></asp:TextBox>
                    </div>         
                    <div class="clear"></div>
                    <asp:LinkButton ID="btnCreateAccount" runat="server" CssClass="button button-m shadow-large bg-blue2-dark button-center-large button-round-large button-margins" OnClick="btnCreateAccount_Click">CREATE ACCOUNT</asp:LinkButton>
