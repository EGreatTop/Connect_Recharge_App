<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="openrechargetopup.aspx.cs"  Inherits="ConnectRechargeWebsite.openrechargetopup" %>
...
<body class="theme-light" data-background="none" data-highlight="blue2">
	...
	<div class="header header-fixed header-logo-center">
        <a href="openrecharge" class="header-title">Open Recharge</a>
    ...
    <div class="page-content header-clear-medium">
        ...
        <div data-height="130" class="caption caption-margins round-medium shadow-huge">
            ...
            <div class="caption-center left-15 text-left">
                <h1 class="color-white bolder">OpenRecharge</h1>
                <p class="under-heading color-white opacity-90 bottom-0">
                    Virtual Top-Up Software
                </p>
                <p class="under-heading color-white opacity-90 bottom-0">
        ...
        <div class="content-boxed">
            <div class="content accordion-style-1 accordion-round-medium">
                ...
                <a href="#" data-accordion="accordion-content-11" class="accordion-toggle-first bg-green2-dark">
                    ...
                    Wallet balance - <asp:Label ID="LblWalletbalance" runat="server" Text="Label"></asp:Label>
                </a>
                <a href="#" data-accordion="accordion-content-12" class="accordion-toggle-last bg-green2-dark">
                    ...
                    ORP Balance - <asp:Label ID="LblORPBalance" runat="server" Text="Label"></asp:Label>
                </a>
                </div>
           </div> 
