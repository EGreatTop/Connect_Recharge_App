<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="ConnectRechargeWebsite.index" %>
    ...
    <div class="page-content header-clear-medium">   
        ...
        <div class="content-boxed left-40 right-40">
            <div class="content top-10 bottom-20">
                <h1 class="center-text uppercase ultrabold fa-3x">ACCESS</h1>
                ...
                <div class="input-style has-icon input-style-1 input-required">
                    ...
                    <em>(required)</em>
                    <asp:DropDownList ID="ddlRouteOption" runat="server">
                    <asp:ListItem Selected="False">Click to Select your Access Route</asp:ListItem>
                    <asp:ListItem>Open Recharge (Sign-up)</asp:ListItem>
                    <asp:ListItem>Open Recharge (Login)</asp:ListItem>
                    <asp:ListItem>Connect Citizen (Sign-up)</asp:ListItem>
                    <asp:ListItem>Connect Citizen (Continue-Sign-up)</asp:ListItem>
                    <asp:ListItem>Connect Citizen (Login)</asp:ListItem>
                    <asp:ListItem>Reset Login Access</asp:ListItem>
                    </asp:DropDownList>
                </div>
                <%--<div class="input-style has-icon input-style-1 input-required">
                    <i class="input-icon fa fa-user font-11"></i>
                ...
                <div class="clear"></div>                
                <!-- <div class="divider top-3"></div>-->
                <asp:LinkButton ID="BtnLogin" CssClass="button button-m shadow-large bg-blue2-dark button-center-large button-round-large button-margins" runat="server"  OnClick="BtnLogin_Click">CONTINUE</asp:LinkButton>
                <br />
                <asp:LinkButton ID="BtnORSignUp" CssClass="button button-m shadow-large bg-blue2-dark button-center-large button-round-large button-margins" runat="server" OnClick="BtnORSignUp_Click">OPEN RECHARGE(SIGN UP)</asp:LinkButton>
                <br />
                <asp:LinkButton ID="BtnORLogin" CssClass="button button-m shadow-large bg-blue2-dark button-center-large button-round-large button-margins" runat="server" OnClick="BtnORLogin_Click">OPEN RECHARGE(LOGIN)</asp:LinkButton>
                <br />
                <asp:LinkButton ID="BtnCRSignup" CssClass="button button-m shadow-large bg-blue2-dark button-center-large button-round-large button-margins" runat="server" OnClick="BtnCRSignup_Click">CONNECT CITIZEN(SIGN UP)</asp:LinkButton>
                <br />
                <asp:LinkButton ID="BtnCRSignUpContinue" CssClass="button button-m shadow-large bg-blue2-dark button-center-large button-round-large button-margins" runat="server" OnClick="BtnCRSignUpContinue_Click">CONNECT CITIZEN(CONTINUE SIGN-UP)</asp:LinkButton>
                <br />
                <asp:LinkButton ID="BtnCRLogin" CssClass="button button-m shadow-large bg-blue2-dark button-center-large button-round-large button-margins" runat="server" OnClick="BtnCRLogin_Click">CONNECT CITIZEN(LOGIN)</asp:LinkButton>
                <br />
                <asp:LinkButton ID="BtnReset" CssClass="button button-m shadow-large bg-blue2-dark button-center-large button-round-large button-margins" runat="server" OnClick="BtnReset_Click">RESET PASSWORD</asp:LinkButton>
                <!--<a href="openrechargeforgot" class="text-center font-16 color-theme opacity-50">Forgot Credentials</a>-->
               <div class="divider bottom-10"></div>
                 <!-- <div class="divider top-5"></div>-->
                <!--<a href="#" class="back-button button button-icon button-full button-xs shadow-large button-round-small font-11 bg-facebook top-30 bottom-0"><i class="fab fa-facebook-f"></i>Sign in with Facebook</a>
                <a href="#" class="back-button button button-icon button-full button-xs shadow-large button-round-small font-11 bg-twitter top-10 bottom-40"><i class="fab fa-twitter"></i>Sign in with Twitter</a>
                <div class="divider bottom-15"></div>
                <div class="one-half">
                    <a href="openrechargesignup" class="font-14 color-theme opacity-70">Create OpenRecharge Account</a>
                </div>
                <div class="one-half last-column">
                <a href="connectcitizensignup2" class="font-14 color-theme opacity-70">Create ConnectCitizen Account</a>
                </div>-->
                <div class="clear"></div>
