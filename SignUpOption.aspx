<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SignUpOption.aspx.cs" Inherits="ConnectRechargeWebsite.SignUpOption" %>
...
<title>ConnectRecharge-Sign Up</title>
    ...
    <div class="page-content header-clear-medium">   
            ...
            <div class="content-boxed left-40 right-40">
                <div class="content top-10 bottom-10">
                    ...
                    <div class="clear"></div>
                    <asp:LinkButton ID="btnCreateAccountOpen" runat="server" CssClass="button button-m shadow-large bg-blue2-dark button-center-large button-round-large button-margins" OnClick="btnCreateAccountOpen_Click">OpenRecharge</asp:LinkButton>
                    <br />
                    <asp:LinkButton ID="btnCreateAccountCitizen" runat="server" CssClass="button button-m shadow-large bg-blue2-dark button-center-large button-round-large button-margins" OnClick="btnCreateAccountCitizen_Click">ConnectCitizen</asp:LinkButton>
