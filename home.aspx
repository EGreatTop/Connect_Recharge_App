<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="home.aspx.cs" Inherits="ConnectRechargeWebsite.home" %>
...
<body class="theme-light" data-background="none" data-highlight="red2">
	...
	<div class="page-content">	
        ...
        <div class="cover-wrapper cover-has-buttons">    
            <a href="menu" class="cover-button button button-round-huge shadow-large button-full bg-blue2-dark left-40 right-40 button-m scale-box">CONTINUE</a>
            ...
            <div class="cover-slider owl-carousel">
                <div data-height="cover" class="caption">
                    ...
                    <div class="caption-bottom bottom-100">
                        <h1 class="center-text bolder font-33 bottom-0 color-blue2-dark">Open Recharge</h1>
                        <h6 class="center-text thiner font-15 bottom-20 ">Top-up Airtime seamlessly</h6>
                        <p class="color-theme boxed-text-huge opacity-80 bottom-50">
                            Sign-up for free and begin to earn free top-up credits as you recharge.
                        </p>
                    </div>
                </div>
                <div data-height="cover" class="caption">
                    ...
                    <div class="caption-bottom bottom-100">
                        <h1 class="center-text bolder font-33 bottom-0 color-blue2-dark">Citizen</h1>
                        <h6 class="center-text thiner font-15 bottom-20">Become a ConnectCitizen</h6>
                        <p class="color-theme boxed-text-huge opacity-80 bottom-50">
                           Enjoy more benefits by becoming a Citizen, earning from the recharge of others and yourself.
                        </p>
                    </div>
                </div>         
                ...
                <div data-height="cover" class="caption">  
                    ...
                    <div class="caption-bottom bottom-100">
                        <h1 class="center-text bolder font-33 bottom-0 color-blue2-dark">Ambassador</h1>
                        <!--<h6 class="center-text thiner font-15 bottom-20 color-highlight">Become a ConnectAmbassador</h6>-->
						<h6 class="center-text thiner font-15 bottom-20">Become a ConnectAmbassador</h6>
                        <p class="color-theme boxed-text-huge opacity-80 bottom-50">
                            Earn commissions, bonuses and global rewards here, become a top earner here. Life just got sweeter .
                        </p>
                    </div>
                </div>            
                <div data-height="cover" class="caption">  
                    ...
                    <div class="caption-bottom bottom-100">
                        <h1 class="center-text bolder font-33 bottom-0 color-blue2-dark">Vendor</h1>
                        <h6 class="center-text thiner font-15 bottom-20">Become a ConnectVendor</h6>
                        <p class="color-theme boxed-text-huge opacity-80 bottom-50">
                            For New and existing entrepreneurs, take your business to the next level earning great commissions.
                        </p>
                    </div>
                </div>
				<div data-height="cover" class="caption">  
                    ...
                    <div class="caption-bottom bottom-100">
                        <h1 class="center-text bolder font-33 bottom-0 color-blue2-dark">Consultants</h1>
                        <h6 class="center-text thiner font-15 bottom-20">Become a ConnectConsultant</h6>
                        <p class="color-theme boxed-text-huge opacity-80 bottom-50">
                            Earn a decent living working with us. We love to see young people succeed.
                        </p>
                    </div>
                </div>
            </div>
...
<!--
	<div class="page-content content-full-height">	
        ...
        <div class="cover-wrapper cover-has-buttons owl-dots owl-only-dots">
            <a href="#" class="cover-button button button-round-huge shadow-large button-full bg-green1-dark button-m">Let's do it!</a>
            <a href="#" class="cover-next color-gray2-dark">Next<i class="fa fa-angle-right left-10"></i></a>
            <a href="#" class="cover-prev color-gray2-dark"><i class="fa fa-angle-left right-10"></i>Previous</a>
            <div class="cover-slider owl-carousel">
                <div data-height="cover-header" class="caption">
                    ...
                    <div class="caption-bottom bottom-50">
                        ...
                        <p class="boxed-text-huge opacity-80 bottom-50">
                            You need a fast Mobile Website to decrease your bounce rate and rank higher in Google mobile search results. 
                        </p>
                    </div>
                </div>  
                <div data-height="cover-header" class="caption">
