<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="connectcitizensignup3.aspx.cs" Inherits="ConnectRechargeWebsite.connectcitizensignup3" %>
    ...
    <div class="page-content header-clear-medium">   
            ...
            <div class="content-boxed left-40 right-40">
                <div class="content top-10 bottom-10">
                    ...
                    <asp:Label ID="LblMessage" runat="server" Text="Enter your Full Name as it appears in your bank account." Visible="false" style="color: #FFFFFF; background-color: #FF0000"></asp:Label>
                    <div class="input-style has-icon input-style-1 input-required">
                        <i class="input-icon fa fa-user font-11"></i>
                        <span>User ID</span>
                        <em>(required)</em>
                        <asp:TextBox ID="txtUserID" runat="server" placeholder="User ID" ReadOnly="true"></asp:TextBox>
                    </div> 
                    <div class="input-style has-icon input-style-1 input-required">
                        <i class="input-icon fa fa-user font-11"></i>
                        <span>Full Name (as in Bank Account)</span>
                        <em>(required)</em>
                        <asp:TextBox ID="txtPartnerName" runat="server" placeholder="Full Name (as in Bank Account)"></asp:TextBox>
                    </div>
                    <div class="input-style has-icon input-style-1 input-required">
                    ...
                    <div class="input-style has-icon input-style-1 input-required">
                        <i class="input-icon fa fa-code font-11"></i>
                        <span>Referrer's Code</span>
                        <em>(required)</em>
                        <asp:TextBox ID="txtRefCode" runat="server" placeholder="Referrer's Code (if any)"></asp:TextBox>
                    </div> 
                    <div class="input-style has-icon input-style-1 input-required">
                    ...
                    <div class="input-style has-icon input-style-1 input-required">
                        <i class="input-icon fa fa-city font-11"></i>
                        <span>City</span>
                        <em>(required)</em>
                        <asp:TextBox ID="txtCity" runat="server" placeholder="City"></asp:TextBox>
                    </div>
                    <div class="input-style has-icon input-style-1 input-required">
                        <i class="input-icon fa fa-location-arrow font-11"></i>
                        <span>State</span>
                        <em>(required)</em>
                    ...
                    <div class="input-style has-icon input-style-1 input-required">
                     ...
                     <div class="input-style has-icon input-style-1 input-required">
                        <i class="input-icon fa fa-save font-11"></i>
                        <span>Bank Name</span>
                        <em>(required)</em>
                        <asp:TextBox ID="txtBankName" runat="server" placeholder="Bank Name"></asp:TextBox>
                    </div> 
                     <div class="input-style has-icon input-style-1 input-required">
                        <i class="input-icon fa fa-file-code font-11"></i>
                        <span>Account No</span>
                        <em>(required)</em>
                        <asp:TextBox ID="txtAccountNo" runat="server" placeholder="Bank Account No."></asp:TextBox>
                    </div>
                    <div class="input-style has-icon input-style-1 input-required">
                        <span>Choose ID:</span>
                        <em><i class="fa fa-angle-down"></i></em>             
                        <asp:DropDownList ID="ddlIdentification" runat="server" AutoPostBack="false">
                    ...
                    <div class="input-style has-icon input-style-1 input-required">
                        ...
                        <em>(required)</em>
                        <asp:TextBox ID="txtIDNo" runat="server" placeholder="Identification Number"></asp:TextBox>
                    </div>  
                    <div class="input-style has-icon input-style-1 input-required">
                        <span>Choose Registration Option:</span>
                        <em><i class="fa fa-angle-down"></i></em>             
                        <asp:DropDownList ID="ddlRegOption" runat="server" AutoPostBack="false">
                        <asp:ListItem Selected="False">- Pls Select -</asp:ListItem>                             
                    ...
                    <div class="clear"></div>
                    <%--<asp:LinkButton ID="btnConfirmName" runat="server" CssClass="button button-m shadow-large bg-blue2-dark button-center-large button-round-large button-margins" OnClick="btnConfirmName_Click">CONFIRM NAME</asp:LinkButton>--%>
                    <asp:LinkButton ID="btnCreateAccount" runat="server" CssClass="button button-m shadow-large bg-blue2-dark button-center-large button-round-large button-margins" OnClick="btnCreateAccount_Click">CONFIRM NAME</asp:LinkButton>
                    <%--<asp:Button ID="btnCreateAccount" runat="server" CssClass="button button-m shadow-large bg-blue2-dark button-center-large button-round-large button-margins" Text="" OnClick="btnCreateAccount_Click" />--%>
                    <div class="divider bottom-20"></div>
                    <div class="bottom-20">
                        <a href="connectcitizenlogin" class="center-text font-11 color-theme">Already Registered? Sign In Here.</a>
                    </div>
